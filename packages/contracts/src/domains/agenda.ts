...
export const agendaDraftSchema = z.object({
   ...
   * `resources` advances when rooms, tracks or slots change. It is on the wire because a consumer
   * storing a decision about a *derived* condition — the operational inbox's dismissals — needs to
   * tell one occurrence of that condition from the next, and the identifiers a condition is made
   * of are reused exactly when it is resolved and recreated (`PRD-OPS-002`, issue #180).
   */
