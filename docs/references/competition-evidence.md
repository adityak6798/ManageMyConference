...
- `EVD-005` Competition evaluator repository. Public locator: <https://github.com/mkly/killmysaas-evals-coding-agent>. Pinned hash: `d8fafa41cdc484309e3fda953c5567cc2d462734`. Reviewed conclusion: evaluator chains CFP through abstract, speaker/content, agenda, and public views; scoring can change and must be revalidated.
