...
Product changes require a `PRD-*` rule, a `JNY-*` journey impact, and an `ACC-*` acceptance test link. Architecture is governed separately under [architecture](../architecture/README.md).
