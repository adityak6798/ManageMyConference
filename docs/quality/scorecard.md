...
| `ACC-DEMO-SMOKE` | evaluator orientation across `JNY-001`–`JNY-009` | clean reset + role-aware discovery + accessibility/performance smoke | passed locally 2026-08-10: deterministic runbook/reset, cross-role discovery, standalone accessibility/performance smoke, 12-test aggregate Playwright suite, 12-test D1 integration suite, build, and full check complete; single-artifact lifecycle acceptance and hosted CI remain pending under issue #10 |
