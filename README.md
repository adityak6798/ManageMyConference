...
is authenticated, how a webhook is signed, and what may change under a client with how much
notice. It is linked from the marketing page's bar and footer, because an API nobody can find from
the home page is one an evaluator concludes does not exist.
