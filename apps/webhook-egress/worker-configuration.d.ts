/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 705c069a1d2d3ec81bcbfa209ed50cf8)
// Runtime types generated with workerd@1.20260811.1 2026-08-14 
interface __BaseEnv_Env {
	WEBHOOK_EGRESS_TOKEN: string;
	WEBHOOK_EGRESS_CONTAINER: DurableObjectNamespace<import("./src/worker").WebhookEgressContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "WebhookEgressContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBHOOK_EGRESS_TOKEN">> {}
}
