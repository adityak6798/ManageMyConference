...
const rebuildCoverage = {
  ...
  "1321_review_decision_dispositions.sql": "copies every decision and recreates its only index",
  "1502_crm_prospect_stage_rebuild.sql": "seeded replay in the CRM D1 integration suite",
  "1504_crm_interest_transition_source.sql": "copies every immutable transition and its index",
